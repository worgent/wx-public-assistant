...
public class MemberServiceImpl implements MemberService{
    ...
    public VipBusiness getVipBusinessByGzhID(int weixinGzhID) {
        ...
        vipBusinessExample.createCriteria().andWeixinGzhIdEqualTo(weixinGzhID);
        List<VipBusiness> vipBusinesses = vipBusinessMapper.selectByExample(vipBusinessExample);
        if( vipBusinesses.size() == 1 ){
            return vipBusinesses.get(0);
        }
        return null;
    }
    @Override
...
//    }
    ...
    public int getBusinnessID(int weixinGzhID) {
        ...
        List<VipBusiness> vipBusinesses = vipBusinessMapper.selectByExample(vipBusinessExample);
        if( vipBusinesses.size() == 1 ){
            return vipBusinesses.get(0).getId();
        }
        return -1;
    }
