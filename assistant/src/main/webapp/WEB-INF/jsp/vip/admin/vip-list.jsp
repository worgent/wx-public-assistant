...
<div class="main">
    ...
    <div class="right col-xs-12">
        ...
        <div class="top-tag">
            <span>会员总数:【${memberCount}】&nbsp;&nbsp;今日新增:【${todayCount}】</span>
        </div>
        <form class="bs-example bs-example-form" role="form" id="formVal" action="/admin/searchVipInfo.do" onsubmit="return searchVipInfo()">
            ...
            <div class="right-search-form col-xs-12">
                ...
                <div class="viplist-select-group">
                    <select name="type" class="selectpicker" data-size="3">
                        <option>全部会员</option>
                    </select>
                </div>
                <div class="viplist-select-group">
                    <select name="searchType" class="selectpicker" data-size="3" id="searchTypeId">
