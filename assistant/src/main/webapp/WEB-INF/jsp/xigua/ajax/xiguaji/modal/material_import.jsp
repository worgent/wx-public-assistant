...
<div class="modal-header">
		...
		<h4 class="modal-title">导入微信文章至素材库</h4>
	</div>
	<div class="modal-body no-padding">
		<form class="smart-form">
			<fieldset>
				...
				<%--<section id="userTagPanel" style="">--%>
					<%--<div class="row">--%>
						<%--<label class="label col col-2">素材文件夹:</label>--%>
						<%--<div class="col col-10 addMyAccountType">--%>
							<%--<label class="select">--%>
								<%--<select id="selectUserTag">--%>
									<%--<option value="0">未归类</option>--%>
									<%--<option value="17">自定义</option>--%>
								<%--</select> <i></i>--%>
							<%--</label>--%>
						<%--</div>--%>
					<%--</div>--%>
	...
	<script type="text/javascript">
		...
		$('#btnLoadMPUrl').click(function () {
			...
			$.getJSON('/user/ajax/material_import.do?mpUrl=' + encodeURIComponent(mpUrl), function (result) {
				if (result.Status) {
