...
echo "#1程序开始抓取"
java -jar /usr/local/article_spider/iweibang/article_spider.jar
echo "程序抓取结束"
...
from article_spider_iweibang.wx_article wa join article_spider_iweibang.wx_category wc 
...
from wpweixin.wpwx_article as wpa join article_spider_iweibang.wx_article as wxa 
